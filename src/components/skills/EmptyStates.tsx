  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-48 py-8">
      <div className="relative">
        <div className="absolute inset-0 bg-primary/5 scale-150" />
        <div className="relative flex flex-col items-center">
          <div className="relative mb-4 sm:mb-5">
            <div className="relative flex h-14 w-14 sm:h-16 sm:w-16 items-center justify-center bg-primary">
          ...
          <h2 className="text-sm sm:text-base font-heading font-bold text-foreground mb-1.5">
            {t('skills.empty')}
          </h2>
  ...
  return (
    <div className="relative overflow-hidden border border-dashed border-border/80 bg-accent/20 p-5">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-sm font-heading font-bold text-foreground mb-1">{t('skills.empty')}</p>
